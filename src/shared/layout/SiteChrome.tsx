 ...
 * over it, so the image runs to the very top of the screen with no bar above it:
 * the landing page, the contact page and the feedback flow. Everywhere else
 * starts on paper and needs the header to carry its own ground — the wordmark is
 * white, so a transparent header on a light page is an invisible one.
 */
