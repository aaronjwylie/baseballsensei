...
| 8.9.52 | **A downloaded review stops saying "Feedback ready"** | The badge reads "Downloaded" at `collected` and `resolved`. ⚠️ All three released rungs read "Feedback ready", so a parent who had already downloaded was still being told to. "Ready" is an instruction |
