...
| 6.18 | A submission assigned but **not yet sent** to the coach | Still absent from the list, as before. A coach's turn starts when the admin hands it over; a card for work they cannot begin is a card they learn to ignore |
